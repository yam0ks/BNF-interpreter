...
template <typename Siterator>
bool Lexer::CheckIfVariable(Siterator begin, Siterator end) const{
...
template <typename Siterator>
std::tuple<int, int, QString> Lexer::ConvertToken(Siterator begin, Siterator end, const QString& code){
...
template <typename Siterator>
Siterator Lexer::word_begin(Siterator from, Siterator to) const{
...
template <typename Siterator>
Siterator Lexer::word_end(Siterator from, Siterator to) const{
...
template <typename Siterator>
bool Lexer::CheckIfNumber(Siterator begin, Siterator end) const{
    while (begin != end && (*begin).isDigit()) ++begin;
    return begin == end;
}

template <typename Siterator>
bool Lexer::CheckIfReal(Siterator begin, Siterator end) const{
...
template <typename Siterator>
bool Lexer::CheckIfStart(Siterator begin, Siterator end) const{
    return BuildString(begin, end) == "Start";
}

template <typename Siterator>
bool Lexer::CheckIfStop(Siterator begin, Siterator end) const{
    return BuildString(begin, end) == "Stop";
}

template <typename Siterator>
bool Lexer::CheckIfFirst(Siterator begin, Siterator end) const{
    return BuildString(begin, end) == "Первое";
}

template <typename Siterator>
bool Lexer::CheckIfSecond(Siterator begin, Siterator end) const{
    return BuildString(begin, end) == "Второе";
}

template <typename Siterator>
bool Lexer::CheckIfThird(Siterator begin, Siterator end) const{
    return BuildString(begin, end) == "Third";
}

template <typename Siterator>
bool Lexer::CheckIfFourth(Siterator begin, Siterator end) const{
    return BuildString(begin, end) == "Fourth";
}

template <typename Siterator>
bool Lexer::CheckIfChar(Siterator begin) const{
    return chars.contains(*begin);
}

template <typename Siterator>
bool Lexer::CheckIfOperation(Siterator begin) const{
    return operations.contains(*begin);
}

template <typename Siterator>
bool Lexer::CheckIfFunction(Siterator begin, Siterator end) const{
    return functions.contains(BuildString(begin, end));
}


template <typename Siterator>
std::tuple<int, QString> Lexer::CheckIfWrongFunction(Siterator begin, Siterator end) const{
...
template <typename Siterator>
QString Lexer::CheckIfWrongVariable(Siterator begin, Siterator end) const{
    auto it = begin;
...
template <typename Siterator>
QString Lexer::BuildString(Siterator begin, Siterator end) const{
    QString result;
...
template <typename Siterator>
bool Lexer::IsOctalDigit(Siterator begin, Siterator end) const{
